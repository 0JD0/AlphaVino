...
<head>
  ...
  <body>
    ...
    <h1 class="center-align">Vinos segun pais</h1>
    ...
    <div class="row">
      ...
      <div class="col s12 m6 l4">
        <div class="card">
          <div class="card-image">
            <img src="../../resources/img/bodega.jpeg">
            <span class="card-title">Vino Italiano</span>
          </div>
      ...
      <div class="col s12 m6 l4">
        <div class="card">
          <div class="card-image">
            <img src="../../resources/img/bodega.jpeg">
            <span class="card-title">Vino Frances</span>
          </div>
          <div class="card-action">
            <a href="#">Comprar</a>
          </div>
      ...
      <div class="col s12 m6 l4">
        <div class="card">
          <div class="card-image">
            <img src="../../resources/img/bodega.jpeg">
            <span class="card-title">Vino Español</span>
          </div>
          <div class="card-action">
            <a href="#">Comprar</a>
          </div>
      ...
      <div class="col s12 m6 l4">
        <div class="card">
          <div class="card-image">
            <img src="../../resources/img/bodega.jpeg">
            <span class="card-title">Vino Ruso</span>
          </div>
          <div class="card-action">
            <a href="#">Comprar</a>
          </div>
      ...
      <div class="col s12 m6 l4">
        <div class="card">
          <div class="card-image">
            <img src="../../resources/img/bodega.jpeg">
            <span class="card-title">Vino Suizo</span>
          </div>
          <div class="card-action">
            <a href="#">Comprar</a>
          </div>
      ...
      <div class="col s12 m6 l4">
        <div class="card">
          <div class="card-image">
            <img src="../../resources/img/bodega.jpeg">
            <span class="card-title">Vino Argentino</span>
          </div>
          <div class="card-action">
            <a href="#">Comprar</a>
          </div>
