...
<head>
  ...
  <body>
    ...
    <h1 class="center-align">Vinos tintos</h1>
    ...
    <div class="row">
      ...
      <div class="col s12 m6 l4">
        <div class="card">
          <div class="card-image">
            <img src="../../resources/img/rojo.jpg">
      ...
      <div class="col s12 m6 l4">
        <div class="card">
          <div class="card-image">
            <img src="../../resources/img/vino tinto.jpg">
            <span class="card-title"></span>
          </div>
          <div class="card-action">
            <a>costo $25.00</a>
